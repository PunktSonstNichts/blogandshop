        ...
        if(product.success && product.available){
          ...
          */
          ...
          if(elem.height() <= 350 || elem.width() <= 320){
            ...
            $.each(product.media.images, function(i, image){
                active = (i == 0) ? "active" : "";
                img_shop_html += "<div class='zalando_shop_image_slider_img " + active + "' style='background-image: url(" + image.thumbnailHdUrl + ");height: 4vmin; width: 4vmin;' data-zalando_id='" + id + "' data-zalando_imgsrc='" + image.mediumHdUrl + "''></div>";

jQuery(document).ready(function($) {
    function apiurl(product_id){
      ...
      return "http://127.0.0.1/Zalando/api";
    }

    $("*[data-zalando]").each(function( index ) {
      var elem = $(this);
      var product_id = elem.attr("data-zalando");
      var post_id = elem.attr("data-postid");
      var id = index;
      elem.attr("data-zalando_id", id);
          ...
          if(product.success && product.available){
            ...
            */
            ...
            if(elem.height() <= 350 || elem.width() <= 320){
              ...
              img_shop_html += "<div class='zalando_img_shop_wrapper' data-zalando_id='" + id + "'><a class='zalando_img_activate' href='" + product.shopUrl + "' target='_blank'><button>Buy @ Zalando</button></a></div>";
            }else{
              ...
              img_shop_html += "<div class='zalando_img_shop_item'>";
              img_shop_html += "<div class='zalando_img_shop_image'>";

              img_shop_html += "<div class='zalando_img_shop_image_main zalando_img_target' data-zalando_id='" + id + "' style='background-image: url(" + product.media.images[0].mediumHdUrl + ")'></div>";
//              img_shop_html += "<img class='zalando_shop_image_main' data-zalando_id='" + id + "' src='" + product.media.images[0].mediumHdUrl + "'/>";

              img_shop_html += "<div class='zalando_img_shop_image_slider'>";
              $.each(getimagearray(product.media.images), function(i, image){
                  active = (i == 0) ? "active" : "";
                  img_shop_html += "<div class='zalando_shop_image_slider_img zalando_img_slider " + active + "' style='background-image: url(" + image.thumbnailHdUrl + ")' data-zalando_id='" + id + "' data-zalando_imgsrc='" + image.mediumHdUrl + "''></div>";
                  img_shop_html += "<img src='" + image.mediumHdUrl + "' style='display:none;'><!-- Preload big img-->"
              });
              img_shop_html += "</div>"; //.zalando_shop_image_slider
              img_shop_html += "</div>"; //.zalando_img_shop_image
              ...
              img_shop_html += "</div>"; // .zalando_img_shop_item
              ...
              img_shop_html += "<div class='zalando_shop_checkout' style='background: white; border-radius: 2px; box-shadow: 0px 1px 2px rgba(33,33,33,0.1);' data-zalando_id='" + id + "'>";
        ...
        ajax(apiurl(product_id), {}, function(product){
          ...
          if(product.success && product.available){
            ...
            shop_html += "<div class='zalando_shop_image_main zalando_img_target' data-zalando_id='" + id + "' style='background-image: url(" + product.media.images[0].mediumHdUrl + ")'></div>";

            shop_html += "<div class='zalando_shop_image_slider'>";
            $.each(getimagearray(product.media.images), function(i, image){
                active = (i == 0) ? "active" : "";
                shop_html += "<div class='zalando_img_shop_image_slider_img zalando_img_slider " + active + "' style='background-image: url(" + image.thumbnailHdUrl + ")' data-zalando_id='" + id + "' data-zalando_imgsrc='" + image.mediumHdUrl + "''></div>";
    ...
    }).on("click", ".zalando_img_slider", function(e){
      var id = $(this).attr("data-zalando_id");
      var imgsrc = $(this).attr("data-zalando_imgsrc");

      $(".zalando_img_target[data-zalando_id='" + id + "']").css("background-image", "url(" + imgsrc + ")");

      $(".zalando_img_slider[data-zalando_id='" + id + "']").removeClass("active");
    ...
    function getimagearray(image_arr){
      console.log(image_arr.slice(0, 3));
      return image_arr.slice(0, 3);
    }
});
